...
const Stats = (props) => {
  ...
  return(
	...
	<Link to={`/${userId}/following`}
	      state={{ userId: userId,
		       userName: myInfo.userName }}>See everyone you follow
	</Link>
      </li>
	...
	<Link to={`/${userId}/liked`}
	      state={{ userId: userId,
		       userName: myInfo.userName }}>Liked thoughts
	</Link>
      </li>
	...
	<Link to={`/${userId}/reThoughts`}
	      state={{ userId: userId,
		       userName: myInfo.userName }}>Link to reThoughts
	</Link>
      </li>
	...
	<Link to={`/${userId}/blocked`}
	      state={{ userId: userId,
		       userName: myInfo.userName }}>Blocked
	</Link>
      </li>
